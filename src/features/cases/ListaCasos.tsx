  ...
  const fetchCasos = useCallback(async (isLoadMore = false) => {
    ...
    try {
      ...
      let query = supabase
        .from('casos')
        .select(`
          id, paciente_nome, especialidade_id, prioridade, historico_clinico, conduta_atual, duvida_clinica, solicitante_id, especialista_id, status, created_at, anexos, devolutiva_conduta, devolutiva_aps, respondido_em, fechado_em, aceito_em,
